...
public class RefreshLayout extends ViewGroup {
     ...
     * 当computeVerticalScrollOffset(view)>0时，可以view继续下拉，
     * 当computeVerticalScrollOffset等于0时，不可以
     *
     * @param view View
     * @return int
     */
     ...
     * 当computeVerticalScrollRange(view) > computeVerticalScrollOffset(view) + computeVerticalScrollExtent(view)时，view可以继续上拉，
     * 当Range等于Offset加上Extent时，不可以
     *
     * @param view View
     * @return int
     */
     ...
     * 设置触发下拉刷新的最小高度。
     *
     * @param headerTriggerMinHeight int
     */
     ...
     * 设置触发下拉刷新的最大高度。
     *
     * @param headerTriggerMaxHeight int
     */
     ...
     * 设置触发上拉加载的最小高度。
     *
     * @param footerTriggerMinHeight int
     */
     ...
     * 设置触发上拉加载的最大高度。
     *
     * @param footerTriggerMaxHeight int
     */
